                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                <h2>Aqui esta tu resumen del dia</h2>
                                            ...
                                            <div
                                                ...
                                                <h2>Mensajes sin leer: {{ $unreadMessages }}</h2>
                                            ...
                                            <div
                                                ...
                                                @foreach ($conversations as  $conversation)
                                                     <h2>Tus conversaciones recientes: {{ $conversation->useer->name}} el {{ date('j F, Y H:i', strtotime($conversation->conversation->last_time_message)) }}</h2>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                ...
                                                                Recives este correo por servicios-online
                                                            </div>
